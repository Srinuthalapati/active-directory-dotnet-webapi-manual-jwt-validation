...
namespace TodoListService-ManualJwt.Models
{
    ...
    /// <summary>
    /// ZoneUpdatePayload for Update Body Parameters
    /// </summary>
    public partial class ZoneUpdatePayload
    {
        /// <summary>
        /// Initializes a new instance of the ZoneUpdatePayload class.
        /// </summary>
        public ZoneUpdatePayload() { }

        /// <summary>
        /// Initializes a new instance of the ZoneUpdatePayload class.
        /// </summary>
        public ZoneUpdatePayload(string zoneFQDN, string owner, string approvalDL, string teamDL, string backendService, string adGroup, string approvalSettings, string serviceAcctGroup, string zoneType)
        {
            ZoneFQDN = zoneFQDN;
            Owner = owner;
